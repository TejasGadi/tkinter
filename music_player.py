...
#OS module provides different functions for interaction with the Operating System.
#We are going to use the OS module for fetching the playlist of songs from the specified directory 
import os

import pickle
#Tkinter:-This framework provides Python users with a simple way to create GUI elements using the widgets found in the Tk toolkit.
...
from pygame import mixer   #Mixer module helps control the music used in pygame programs.  
...
class Player(tk.Frame):
	def __init__(self, master=None):
		...
		self.master = master
		self.pack()         #packs various components such as buttons into the main wideget(window)
		mixer.init()        #Mixer module helps control the music used in pygame programs
	...
	def create_frames(self):
		self.track = tk.LabelFrame(self, text='Song Track',
					...
					bg="grey",fg="white",bd=5,relief=tk.GROOVE)     #bd-width of the border(pixels)
	...
	def control_widgets(self):
		...
		self.slider.set(8)
		mixer.music.set_volume(0.8)      #set the music volume
